...
const Footer = () => {
  ...
  return (
    <div className="bg-gray-700 p-5">
        ...
        <div>
          ...
          <ul className="pl-2">
            {product.map((each) => (
              <li
                key={each.id}
                className="hover:first-letter:text-3xl md:py-1 cursor-pointer"
              >
      ...
      <hr />
      <p className="text-center font-serif text-gray-200 py-1 md:text-lg">Copyright © 2024 - StonePedia Private Limited. All Rights Reserved.</p>
    </div>
  );
};
